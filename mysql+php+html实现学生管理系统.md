...
本文使用Mysql+php+html实现一个简单的学生管理系统，实现了登陆，注册，总览学生信息，添加学生，查询特定的学生，删除指定的学生等功能。并且本文仅用来学习就够了，因为在实际开发中都会使用框架比如前端的vue.js，后端用的springboot，使用这些框架能大幅提高开发效率，避免重复造轮子，所以不必要进行太过深入地了解这些技术。:slightly_smiling_face:
